...
| Аналитика аэропорта| Анализ спроса пассажиров на рейсы в города, где проходят крупнейшие фестивали. Состоит из двух частей: подготовка [запросов](sql_query) из БД и проведение исследования в [ноутбуке](airports_analytics)| BeautifulSoup, Matplotlib.pyplot, Pandas, Requests, Stats |
