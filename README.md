...
| [ч1. Аналитика аэропорта (подготовка запросов](sql_query.sql), [ч2. Аналитика аэропорта (ноутбук)](airports_analytics)| Анализ спрос пассажиров на рейсы в города, где проходят крупнейшие фестивали | BeautifulSoup, Matplotlib.pyplot, Pandas, Requests, Stats |
